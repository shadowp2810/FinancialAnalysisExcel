...
Accounting is an information science that is used 
...
The idea that the Revenues and costs should 
...
General Ledgers Account is an Account 
...
Bootstrapping is Founders of Startups 
...
Between 2007 and 2017 the S&P 500 
...
<br>
  ...
  eg 
   ...
   That is adjust the Company's Beta 
   for the risk profile of the industry in which 
   the project will be carried out. 
   And the amount of leverage for the project. 
   eg
    Company's Beta = 0.6, 
    Debt/Equity = 1.86x or 65%, 
    Tax Rate = 30%
    First we must deliver company's Beta, 
    that is calculate a Beta independent of firm's capital structure. 
    Beta[n] 
     = (1 / (1 + (1-t)*(D/E))) * Beta[l]
     = (1 / (1 + (1-0.3)*(1.86))) * 0.6 
     = 0.26
...
eg 
 ...
 By estimating potential demand and price at which bicycles can be sold, 
 we obtain a projection of revenue figures. 
 Projected Revenue 
  = Demand * Price
...
Capital Budgeting Practical Exercise: 
 ...
 Now we work to find the Discounted Cash Flows
  ...
  Discounted Cash Flows
   ...
   because interest expenses have already been taken 
   into consideration in the Net Cash Flow.  
...
Tesla Company Analysis:
 ...
 GM, Ford, Fiat Chrysler, BMW and Volkswagen.
